...
export const FloatingAssistant: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'init-1',
      sender: 'bot',
      text: 'আসসালামু আলাইকুম! MASTERMIND AIDITIT AI অ্যাসিস্ট্যান্ট থেকে আপনাকে স্বাগতম। আপনার কি ধরনের প্রশ্ন বা কোর্স সাহায্য প্রয়োজন?',
    },
  ]);
  ...
  const handleSend = (userText: string) => {
      ...
      setTimeout(() => {
        ...
        setMessages((prev) => [
          ...prev,
          {
            ...
            isError: true,
            rawError: 'ERR_NET_TIMEOUT: Failed to reach api.mastermindaiditit.com/v1/chat',
          },
        ]);
      }, 1000);
      return;
    ...
    setTimeout(() => {
      setStatusText('MASTERMIND AIDITIT is generating...');
      ...
      if (userText.includes('ফ্রি') || userText.includes('ফ্রিতে')) {
        botReply =
          'MASTERMIND AIDITIT প্ল্যাটফর্মে ওয়ার্ডপ্রেস প্লাগইন ডেভেলপমেন্ট, ফাইভার ফ্রিল্যান্সিং এবং রেসপন্সিভ ওয়েব ডিজাইন সম্পূর্ণ ফ্রিতে পাচ্ছেন! যেকোনো ফ্রি কোর্সে ক্লিক করে সাথে সাথে দেখা শুরু করুন।';
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-sm font-extrabold flex items-center gap-1">
                    <span>MASTERMIND AIDITIT AI</span>
                    <CheckCircle2 className="w-3.5 h-3.5 text-brand-400" />
                  </h4>
                  <p className="text-[10px] text-slate-300 font-semibold">
                    MASTERMIND AIDITIT Support Advisor
                  </p>
                </div>
              </div>
